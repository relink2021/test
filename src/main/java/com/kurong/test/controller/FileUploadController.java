...
import com.kurong.test.service.FileUpLoadService;
...
public class FileUploadController {
    ...
    public String upload(@RequestParam("file") MultipartFile uploadFile)
            throws Exception {
        return JSON.toJSONString(fileUploadService.upload(uploadFile));
    }
    ...
    public String delete(@RequestParam("fileName") String objectName)
            throws Exception {
        return JSON.toJSONString(fileUploadService.delete(objectName));
    }
